...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("JaniMusic/assets/thumb/font2.ttf", 32)
        regular_font = ImageFont.truetype("JaniMusic/assets/thumb/font.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "JaniMusic/assets/thumb/play_icons.png"
